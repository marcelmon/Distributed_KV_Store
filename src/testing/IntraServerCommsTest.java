...
//		}
	...
	public void testRPCSendArgs() throws Exception {
		...
		// Make call:
		comms.call("h:1234", RPCMethod.MoveData, "arg0", "arg10", "localhost");
		...
		assertTrue(splnode.length == 2);
		System.out.println(splnode[0]);
		assertTrue(splnode[0].equals("h:1234"));
	...
	public void testRPCReceiveArgs() throws Exception {
		...
		zk.create(rpcGroup + "/i:1234-", rec.getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT_SEQUENTIAL);
		Thread.sleep(100);
